...
void NinjaTrap::ninjaShoebox(ScavTrap & scav) {
	...
	std::cout << "NinjaTrap: \"Cool! Now we're both super-crazy-amazing!\"" << std::endl;
...
void NinjaTrap::ninjaShoebox(FragTrap & frag) {
	...
	std::cout << "NinjaTrap: \"Get ready for some Fragtrap face time!\""
			  << std::endl;
...
void NinjaTrap::ninjaShoebox(NinjaTrap & ninja) {
		...
		std::cout << "WOW! " << "NinjaTrap meets " << ninja._name
